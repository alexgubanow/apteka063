...
public partial class UpdateHandlers
{
    ...
    private static async Task OnPillsReplyReceived(ITelegramBotClient botClient, CallbackQuery callbackQuery, dbc.Order? order = null)
    {
        ...
        await botClient.SendTextMessageAsync(chatId: callbackQuery.Message.Chat.Id, text: Resources.Translation.PickÑategory, replyMarkup: new InlineKeyboardMarkup(buttons));
    }
